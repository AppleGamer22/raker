...
export function ApplePasswordManagerIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg
			{...props}
			viewBox="0 0 203.977 233.942"
			fillRule="evenodd"
			clipRule="evenodd"
			strokeLinejoin="round"
			strokeMiterlimit={2}
		>
			<g transform="translate(-55.027, -43.603)">
				<path
				...
				<g clipPath="url(#a)">
					<path d="M126.531 277.545V43.603H55.027v233.942h71.504Z" fill="url(#b)" />
				</g>
				<path
				...
				<g clipPath="url(#c)">
					<path d="M168.043 277.545V43.603H96.54v233.942h71.503Z" fill="url(#d)" />
				</g>
				...
				<g clipPath="url(#e)">
					<path d="M259.004 277.545V43.603H137.958v233.942h121.046Z" fill="url(#f)" />
				</g>
				<defs>
					<linearGradient
						id="b"
					...
					>
						<stop offset="0" stopColor="#ffdd53" stopOpacity={1} />
						<stop offset="1" stopColor="#ffbf01" stopOpacity={1} />
					</linearGradient>
					<linearGradient
						id="d"
						x1="0"
					...
					>
						<stop offset="0" stopColor="#51e376" stopOpacity={1} />
					...
					>
						<stop offset="0" stopColor="#62ccf8" stopOpacity={1} />
						<stop offset="1" stopColor="#0079ff" stopOpacity={1} />
					</linearGradient>
				</defs>
			</g>
		</svg>
