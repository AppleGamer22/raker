...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.historyAddCategoryStmt, err = db.PrepareContext(ctx, historyAddCategory); err != nil {
		return nil, fmt.Errorf("error preparing query HistoryAddCategory: %w", err)
	}
	if q.historyAddFileStmt, err = db.PrepareContext(ctx, historyAddFile); err != nil {
		return nil, fmt.Errorf("error preparing query HistoryAddFile: %w", err)
	}
	...
	if q.historyRemoveCategoryStmt, err = db.PrepareContext(ctx, historyRemoveCategory); err != nil {
		return nil, fmt.Errorf("error preparing query HistoryRemoveCategory: %w", err)
	}
	...
	if q.userCategoriesGetStmt, err = db.PrepareContext(ctx, userCategoriesGet); err != nil {
		return nil, fmt.Errorf("error preparing query UserCategoriesGet: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.historyAddCategoryStmt != nil {
		if cerr := q.historyAddCategoryStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing historyAddCategoryStmt: %w", cerr)
		}
	}
	if q.historyAddFileStmt != nil {
		if cerr := q.historyAddFileStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing historyAddFileStmt: %w", cerr)
		}
	}
	...
	if q.historyRemoveCategoryStmt != nil {
		if cerr := q.historyRemoveCategoryStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing historyRemoveCategoryStmt: %w", cerr)
		}
	}
	...
	if q.userCategoriesGetStmt != nil {
		if cerr := q.userCategoriesGetStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing userCategoriesGetStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		historyAddCategoryStmt:         q.historyAddCategoryStmt,
		historyAddFileStmt:             q.historyAddFileStmt,
